...
user2 = User.create!(email: "user2@gmail.com", password: "12345678", first_name: "Kacper", last_name: "Petersen")
user3 = User.create!(email: "user3@gmail.com", password: "12345678", first_name: "Angelica", last_name: "Doherty")
user4 = User.create!(email: "user4@gmail.com", password: "12345678", first_name: "Julia", last_name: "Clausen")
user5 = User.create!(email: "user5@gmail.com", password: "12345678", first_name: "Paul", last_name: "Eichhorn")
user6 = User.create!(email: "user6@gmail.com", password: "12345678", first_name: "Frederic", last_name: "Kruse")
...
Slot.create!(day: "Tuesday", time: "15:00", activity_id: activity15.id)
Slot.create!(day: "Saturday", time: "17:00", activity_id: activity15.id)
Slot.create!(day: "Saturday", time: "17:00", activity_id: activity5.id)
Slot.create!(day: "Wednesday", time: "17:00", activity_id: activity15.id)
Slot.create!(day: "Saturday", time: "10:00", activity_id: activity15.id)
Slot.create!(day: "Tuesday", time: "13:00", activity_id: activity15.id)
