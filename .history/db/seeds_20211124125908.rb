...
slot1 = Slot.create!(day: "Monday", time: DateTime.strptime("12/08/2021 15:30", "%m/%d/%Y %H:%M"), activity_id: activity1.id)
slot2 = Slot.create!(day: "Monday", time: DateTime.strptime("12/08/2021 15:30", "%m/%d/%Y %H:%M"), activity_id: activity2.id)
slot3 = Slot.create!(day: "Wednesday", time: DateTime.strptime("12/11/2021 17:30", "%m/%d/%Y %H:%M"), activity_id: activity1.id)
slot4 = Slot.create!(day: "Wednesday", time: DateTime.strptime("12/11/2021 17:30", "%m/%d/%Y %H:%M"), activity_id: activity2.id)
slot5 = Slot.create!(day: "Wednesday", time: DateTime.strptime("12/11/2021 17:30", "%m/%d/%Y %H:%M"), activity_id: activity3.id)
slot6 = Slot.create!(day: "Friday", time: DateTime.strptime("12/15/2021 15:30", "%m/%d/%Y %H:%M"), activity_id: activity2.id)
slot7 = Slot.create!(day: "Friday", time: DateTime.strptime("12/15/2021 15:30", "%m/%d/%Y %H:%M"), activity_id: activity3.id)
slot8 = Slot.create!(day: "Friday", time: DateTime.strptime("12/19/2021 18:30", "%m/%d/%Y %H:%M"), activity_id: activity3.id)
