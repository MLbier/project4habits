...
slot6 = Slot.create!(day: "Friday", time: DateTime.strptime("12/08/2021 15:30", "%m/%d/%Y %H:%M"), activity_id: activity2.id)
slot7 = Slot.create!(day: "Friday", time: DateTime.strptime("12/08/2009 15:30", "%m/%d/%Y %H:%M"), activity_id: activity3.id)
slot8 = Slot.create!(day: "Friday", time: DateTime.strptime("12/08/2009 15:30", "%m/%d/%Y %H:%M"), activity_id: activity3.id)
