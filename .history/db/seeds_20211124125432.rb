...
slot1 = Slot.create!(day: "Monday", time: DateTime.strptime("12/08/2009 15:30", "%m/%d/%Y %H:%M"), activity_id: activity1.id)
slot2 = Slot.create!(day: "Monday", time: DateTime.new(2021-12-08 15:30:00), activity_id: activity2.id)
slot3 = Slot.create!(day: "Wednesday", time: DateTime.new(2021-12-08 15:30:00), activity_id: activity1.id)
slot4 = Slot.create!(day: "Wednesday", time: DateTime.new(2021-12-08 15:30:00), activity_id: activity2.id)
slot5 = Slot.create!(day: "Wednesday", time: DateTime.new(2021-12-08 15:30:00), activity_id: activity3.id)
slot6 = Slot.create!(day: "Friday", time: DateTime.new(2021-12-08 15:30:00), activity_id: activity2.id)
slot7 = Slot.create!(day: "Friday", time: DateTime.new(2021-12-08 15:30:00), activity_id: activity3.id)
slot8 = Slot.create!(day: "Friday", time: DateTime.new(2021-12-08 15:30:00), activity_id: activity3.id)
